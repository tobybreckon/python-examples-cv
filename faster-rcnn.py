...
# Shaoqing Ren, Kaiming He, Ross Girshick, Jian Sun - https://arxiv.org/abs/1506.01497
...
# mv faster_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb faster_rcnn_inception_v2_coco_2018_01_28.pb
...
# parse command line arguments for camera ID or video file, and Faster R-CNN files
...
parser.add_argument("-cl", "--class_file", type=str, help="list of classes", default='object_detection_classes_coco.txt')
parser.add_argument("-cf", "--config_file", type=str, help="network config", default='faster_rcnn_inception_v2_coco_2018_01_28.pbtxt')
parser.add_argument("-w", "--weights_file", type=str, help="network weights", default='faster_rcnn_inception_v2_coco_2018_01_28.pb')
        ...
        for detection in result[0, 0]:
                ...
                if confidence > confThreshold:
                    ...
                    if width <= 2 or height <= 2:
                        ...
                        width = right - left + 1
                        height = bottom - top + 1
                    classIds.append(int(detection[1]))  # no background label for F-RCNN
...
if (((args.video_file) and (cap.open(str(args.video_file))))
    ...
    while (keep_processing):
        ...
        # create a 4D tensor (OpenCV 'blob') from image frame (pixels not scaled, image resized)
        tensor = cv2.dnn.blobFromImage(frame, 1.0, (inpWidth, inpHeight), [0,0,0], swapRB=False, crop=False)
